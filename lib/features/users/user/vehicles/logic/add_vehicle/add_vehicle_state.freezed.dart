...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AddVehicleState);
}
...
/// @nodoc
class $AddVehicleStateCopyWith<$Res>  {
$AddVehicleStateCopyWith(AddVehicleState _, $Res Function(AddVehicleState) __);
}
...
class _Changed implements AddVehicleState {
...
@override
String toString() {
  return 'AddVehicleState.changed(tick: $tick)';
}
...
/// @nodoc
abstract mixin class _$ChangedCopyWith<$Res> implements $AddVehicleStateCopyWith<$Res> {
...
class _Submitting implements AddVehicleState {
  const _Submitting();
...
@override
String toString() {
  return 'AddVehicleState.submitting()';
}
...
class _Success implements AddVehicleState {
...
@override
String toString() {
  return 'AddVehicleState.success(vehicle: $vehicle)';
}
...
/// @nodoc
abstract mixin class _$SuccessCopyWith<$Res> implements $AddVehicleStateCopyWith<$Res> {
...
class _Failure implements AddVehicleState {
...
@override
String toString() {
  return 'AddVehicleState.failure(message: $message)';
}
...
/// @nodoc
abstract mixin class _$FailureCopyWith<$Res> implements $AddVehicleStateCopyWith<$Res> {
